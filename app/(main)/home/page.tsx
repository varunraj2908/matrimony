...
const ProfileCard = ({ profile, subText }: { profile: Profile; subText?: string }) => (
  <div className="shrink-0 w-32 cursor-pointer group">
    ...
    <p className="text-xs font-semibold text-gray-800 truncate leading-tight">{profile.name}</p>
    <p className="text-[10px] text-gray-500">{profile.age} Yrs, {profile.height}</p>
    {subText && <p className="text-[9px] text-gray-400 mt-0.5">{subText}</p>}
  </div>
);
  ...
  <div>
    <div className="flex items-center justify-between mb-3 bg-[#b22234] p-4">
      <div>
        <h2 className="text-base font-bold text-white">
          {title}{" "}
          {count !== undefined && <span className="text-white font-normal">({count.toLocaleString()})</span>}
        </h2>
        <p className="text-xs text-white">{subtitle}</p>
      </div>
      <button className="flex items-center gap-1 text-xs text-white font-semibold hover:underline border border-white px-3 py-1.5 rounded-full transition-colors hover:bg-orange-50 hover:text-[#b22234]">
        View all <ChevronRight />
      </button>
    </div>
    <div className="flex gap-3 overflow-x-auto scrollbar-hide p-4">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 flex gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 text-center">
            ...
            <div className="relative w-20 h-20 mx-auto mb-3">
              ...
              <button
                ...
                className="absolute inset-0 rounded-full flex items-end justify-center pb-1 bg-black/0 hover:bg-black/35 transition-all duration-200 group/cam focus:outline-none focus:ring-2 focus:ring-[#b22234] focus:ring-offset-2"
              >
                <span className="opacity-0 group-hover/cam:opacity-100 transition-opacity duration-200 bg-black/60 rounded-full p-1">
                  {isUploading ? (
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="animate-spin">
            ...
            <div className="flex items-center justify-center gap-1 text-[10px] text-[#b22234] font-medium mb-1">
              <svg width="10" height="10" viewBox="0 0 24 24" fill="#b22234">
                <path d="M9 12l2 2 4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0z" fill="none" stroke="#b22234" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-5">
            <div className="flex items-center justify-between mb-3 bg-[#b22234] p-4">
              <div>
                <h2 className="text-base font-bold text-white">Daily Recommendations</h2>
                <p className="text-xs text-white">Recommended matches for today</p>
              </div>
              <div className="flex items-center gap-2">
                <button onClick={scrollLeft} className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center text-gray-500 hover:border-[#ea580c] hover:text-[#ea580c] bg-white shadow-sm">
                  <ChevronLeft />
                </button>
                <button onClick={scrollRight} className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center text-gray-500 hover:border-white hover:text-[#ea580c] bg-white shadow-sm">
                  <ChevronRight />
                </button>
                <Timer />
                <button className="flex items-center gap-1 text-xs text-white font-semibold hover:underline border border-white px-3 py-1.5 rounded-full hover:bg-orange-50 hover:text-[#b22234] transition-colors">
                  View all <ChevronRight />
                </button>
              </div>
            </div>
          ...
          {/* ── New Matches ── */}
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-5">
            <SectionRow title="New Matches" subtitle="Members who match your preferences and have joined in the last 30 days" count={4737} profiles={NEW_MATCHES} />
          </div>
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-5 mb-5 flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500 mb-2">Personalised matchmaking service</p>
              <h3 className="text-base font-bold text-gray-800 mb-2">
                Find your match <span className="text-[#ea580c]">10x faster</span>
              </h3>
              <p className="text-xs text-gray-600 mb-3">Personalized matchmaking service through expert Relationship Manager</p>
              <div className="space-y-1 mb-4">
              ...
              <button className="bg-[#ea580c] text-white text-xs font-bold px-5 py-2 rounded-full hover:bg-orange-600 transition-colors">Know more</button>
            </div>
            <div className="w-28 shrink-0 ml-4">
              <img src="https://picsum.photos/seed/assisted/112/140" alt="Assisted Service" className="w-full h-36 object-cover rounded-lg"
          ...
          {/* ── Photo/Horoscope Requests ── */}
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 mb-5">
            <h2 className="text-base font-bold text-gray-800 mb-1">Photo/Horoscope Requests</h2>
            <div className="flex gap-4 border-b border-gray-200 mb-4">
              <button className="text-xs font-semibold text-[#ea580c] border-b-2 border-[#ea580c] pb-2 px-1">
                Requests received (3)
              </button>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-[10px] text-gray-500 mb-2">3 members have requested you to add Horoscope to your profile</p>
                <button className="bg-[#ea580c] text-white text-xs font-bold px-4 py-1.5 rounded-full hover:bg-orange-600 transition-colors">Add Horoscope</button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 mb-5">
            <div className="flex items-center justify-between mb-3">
              <div>
                <h2 className="text-base font-bold text-gray-800">Profiles You Shortlisted <span className="text-gray-500 font-normal">(1)</span></h2>
                <p className="text-xs text-gray-500">Members that you have shortlisted</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="shrink-0 w-36 cursor-pointer group">
                ...
                <p className="text-xs font-semibold text-gray-800">Pallavi Madanan</p>
                <p className="text-[10px] text-gray-500">30 Yrs, 5 ft 6 in, M.S.(Engg.), Not Working, United States of America</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 mb-5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm font-semibold text-gray-700">Profiles You Marked As "Don't show" (3)</p>
              </div>
              <button className="flex items-center gap-1 text-xs text-[#ea580c] font-semibold hover:underline border border-[#ea580c] px-3 py-1.5 rounded-full hover:bg-orange-50 transition-colors">
                View all <ChevronRight />
              </button>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 mb-5">
            <div className="flex items-center justify-between mb-1">
              <h2 className="text-base font-bold text-[#ea580c]">Lakhs of Happy Marriages!</h2>
              <div className="flex items-center gap-2">
                <img src="https://picsum.photos/seed/limca/60/40" alt="Limca Book of Records" className="h-10 w-16 object-cover rounded" />
              </div>
            </div>
            <p className="text-xs text-gray-500 mb-4">Featured in the Limca Book of Records for highest number of documented marriages online</p>
            <div className="flex gap-3 overflow-x-auto pb-2 mb-4">
              {SUCCESS_STORIES.map((story) => (
                <div key={story.id} className="shrink-0 w-44 border border-gray-100 rounded-lg overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                  <img src={story.photo1} alt={story.names} className="w-full h-32 object-cover"
                  ...
                  <div className="p-2">
                    <p className="text-[11px] font-semibold text-gray-800 leading-tight mb-0.5">{story.names}</p>
                    <p className="text-[9px] text-gray-400 mb-1">Posted on: {story.date}</p>
                    <p className="text-[10px] text-gray-600 leading-snug">{story.text}</p>
                    <button className="text-[10px] text-[#ea580c] font-semibold mt-1 hover:underline">Read more...</button>
                  </div>
                </div>
              ))}
              <div className="shrink-0 w-8 flex items-center justify-center">
          ...
          {/* ── Other Services ── */}
          <div className="mb-5">
            <h2 className="text-base font-bold text-gray-800 mb-3">Matrimony.com - Other Services</h2>
            <div className="grid grid-cols-3 gap-3">
              {[
                {
                ...
                },
                {
                  ...
                  desc: "India's Largest Wedding Planning Platform",
                  features: ["Photographers, Makeup artists, Caterers and more. Hire best vendors!", "Trusted wedding market place from matrimony.com group", "2.8 Lakh+ trusted vendors across 40+ cities"],
                  cta: "Know more", color: "bg-purple-50 border-purple-200",
                },
                {
                  name: "mandap", sub: "from Matrim...",
                  desc: "India's Lar... Platform",
                  features: ["Fr...", "100%...", "40,00...", "Servic..."],
      ...
      <div className="bg-white border-t border-gray-200 py-3 px-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            <p className="text-sm font-semibold text-gray-700">Need help in using KeralaMatrimony?</p>
            <p className="text-xs text-gray-500">Reach out to us on this number or chat with us</p>
          </div>
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 border border-gray-300 text-gray-700 text-xs font-semibold px-4 py-2 rounded-full hover:border-[#ea580c] hover:text-[#ea580c] transition-colors">
              <PhoneIcon /> Call now
